...
Hooks run at eight event points during a session. The full list is in [CLAUDE.md § Active hooks](../CLAUDE.md#active-hooks); this section explains *when* each event fires relative to a tool call.
