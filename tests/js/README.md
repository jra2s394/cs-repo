...
| `test_report_theme.js` | 25 | `lib/report-theme.js` — kpiStrip width math (n=1–12), tblGrid-vs-cells regression, delta=0 regression, dataTable rows: undefined regression (round-21), buildDocument smoke, publishReport contract |
| `test_data_loader.js` | 27 | `lib/data-loader.js` — loadJson, requireFields, ensureOutDir, dateSlug edge cases (digit-strip + natural-language parse) |
