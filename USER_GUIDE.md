...
1. Run all 682 automated tests first (`make test`) — if any fail, it stops and tells you exactly what's wrong
...
```
make test    # 682 automated tests (525 Python + 157 JavaScript)
