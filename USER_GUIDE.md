...
1. Run all 676 automated tests first (`make test`) — if any fail, it stops and tells you exactly what's wrong
...
```
make test    # 676 automated tests (521 Python + 155 JavaScript)
...
If all pass you'll see `521 passed, 0 failed` (Python), each JS suite prints its own count, and both linters print "All checks passed!".
