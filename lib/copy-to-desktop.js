 ...
 * @param {string} category  One of: "Intercom", "Onboarding", "Renewals", "QBR",
 *                           "Health Reports", "Executive Summaries". Must match
 *                           the per-OS subfolder created by scripts/setup-desktop.*.
