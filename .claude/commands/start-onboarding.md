...
| Field | Example |
|---|---|
| Customer name | Centex Materials |
| Customer slug (short, no spaces) | Centex |
| CARR | $48,000 |
| CSM owner | Tripp Arnold |
| Target go-live date | August 1, 2026 |
| Key contacts (name, role, email, phone) | Remus Key — VP Ops — remus@centex.com — 555-1234 |
...
- Location: Customer Success / Onboarding
  (https://drive.google.com/drive/u/0/folders/1FGb57p0iKuJ1RhRGwrRez3q3RIUvF-bI)
...
- `parentFolderId`: `1FGb57p0iKuJ1RhRGwrRez3q3RIUvF-bI`

Note the new folder URL.

**If Drive MCP does not support folder creation** (returns an error or unsupported operation): Tell the user: "Drive folder creation is not supported by the current MCP — please create the folder manually here: https://drive.google.com/drive/u/0/folders/1FGb57p0iKuJ1RhRGwrRez3q3RIUvF-bI — name it `{Customer Name}`."
