...
Run `make test` first. If any of the 682 tests fail (525 Python + 157 JS), stop and report failures — do not proceed with the review. Then run `make lint` to confirm ruff and biome are both clean.
